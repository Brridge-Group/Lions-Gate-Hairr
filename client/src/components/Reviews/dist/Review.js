...
exports.Review = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'Review-container' },
            ...
            user && user._id !== props.ownerId ? (React.createElement(react_router_dom_1.Link, { to: { pathname: props.id + '/add-review', state: props.name }, className: 'Btn-Primary review' }, "Leave a Review")) : null)));
};
