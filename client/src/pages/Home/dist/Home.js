    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, localStorage.getItem('profile') === null ? (react_1["default"].createElement("div", { className: ' FeatureContainer_image Home' },
        react_1["default"].createElement("div", { className: 'FeatureContainer' },
            react_1["default"].createElement("div", { className: 'Home_inputGroup' },
                ...
                react_1["default"].createElement("form", { onSubmit: itemSubmitHandler },
                    react_1["default"].createElement("input", { type: 'search', className: 'Home_input', value: city, onChange: handleChange, autoFocus: true })))))) : (react_1["default"].createElement("div", { className: ' FeatureContainer_image LoggedIn' },
        react_1["default"].createElement("div", { className: 'FeatureContainer' },
            react_1["default"].createElement("div", { className: 'Home_inputGroup' },
                react_1["default"].createElement("h3", null, "I'm looking for hair stylist in"),
                react_1["default"].createElement("form", { onSubmit: itemSubmitHandler },
                    react_1["default"].createElement("input", { type: 'search', className: 'Home_input', value: city, onChange: handleChange, autoFocus: true }))))))));
};
