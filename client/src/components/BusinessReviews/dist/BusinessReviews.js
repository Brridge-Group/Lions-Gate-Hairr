...
exports.BusinessReviews = function (props) {
    ...
    return (React.createElement("ul", { className: 'BusinessReviews_container' }, !loading &&
        businessReview.map(function (r) { return (React.createElement("li", { key: r.data.review._id, className: 'Business_reviews' },
