  ...
  return (
    <div className="Profile_user">
      ...
      <div className='Profile_links'>
        <Link to={`/users/${user._id}`}>   <h6 className='btn--btn-primary'>update profile</h6>  </Link>
        <Link to={'/add-business'}>  <h6 className='btn--btn-primary twoLines'>add a<br /> business</h6></Link>
      </div>
    </div>
  )
}